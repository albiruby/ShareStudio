...
const UNIQUE_TEMPLATES: TemplateItem[] = [
  ...
  { type: 'elevation_gradient', label: 'Elevation Gradient', category: 'Single' },
  { type: 'minimal_horizontal', label: 'Minimal Horizontal', category: 'Single' },
  { type: 'serif_classic', label: 'Serif Classic', category: 'Single' },
  { type: 'barcode_ticket', label: 'Barcode Ticket', category: 'Retro' },
  { type: 'splits_list', label: 'Splits List', category: 'Chart' },
  { type: 'receipt', label: 'Receipt', category: 'Single' },
  { type: 'speedometer', label: 'Speedometer', category: 'Chart' },
  { type: 'splits_histogram', label: 'Splits Histogram', category: 'Chart' },
  { type: 'polyline_track', label: 'Polyline Track', category: 'Map' },
  { type: 'windows_error', label: 'Windows Error', category: 'Retro' },
  { type: 'mbanking', label: 'M-Banking', category: 'Retro' },
  { type: 'getty_stamp', label: 'Getty Stamp', category: 'Retro' },
  { type: 'cigarette_warning', label: 'Cigarette Warning', category: 'Retro' },
  { type: 'imessage', label: 'iMessage', category: 'Retro' },
  { type: 'ios_call', label: 'iOS Call', category: 'Retro' },
  { type: 'sticky_note', label: 'Sticky Note', category: 'Single' },
  { type: 'nutrition_facts', label: 'Nutrition Facts', category: 'Retro' },
  { type: 'instagram_post', label: 'Instagram Post', category: 'Retro' },
  { type: 'serif_magazine', label: 'Serif Magazine', category: 'Single' },
  { type: 'marathon_milestone', label: 'Marathon Milestone', category: 'Badge' },
  { type: 'cadence_rpm', label: 'Cadence RPM', category: 'Chart' },
  { type: 'hr_zone_meter', label: 'HR Zone Meter', category: 'Chart' },
  { type: 'newspaper_headline', label: 'Newspaper Headline', category: 'Retro' },
  { type: 'spotify_player', label: 'Spotify Player', category: 'Retro' },
  { type: 'airport_boarding_pass', label: 'Boarding Pass', category: 'Retro' },
  { type: 'cassette_tape', label: 'Cassette Tape', category: 'Retro' },
  { type: 'polaroid_frame', label: 'Polaroid Frame', category: 'Retro' },
  { type: 'cyberpunk_neon', label: 'Cyberpunk Neon', category: 'Retro' },
  { type: 'workout_summary_grid', label: 'Workout Summary', category: 'Recap' },
  { type: 'weekly_recap_ring', label: 'Weekly Recap Ring', category: 'Recap' },
  { type: 'icon_badge', label: 'Icon Badge', category: 'Badge' },
  { type: 'minimal_minimalist', label: 'Minimal Minimalist', category: 'Single' },
  { type: 'retro_badge', label: 'Retro Badge', category: 'Retro' },
  { type: 'futuristic_glass', label: 'Futuristic Glass', category: 'Badge' },
  { type: 'minimal_circle', label: 'Minimal Circle', category: 'Single' },
  { type: 'compact_split', label: 'Compact Split', category: 'Single' },
  ...
  { type: 'circle_grid', label: 'Circle Grid', category: 'Chart' },
  { type: 'monthly_chart', label: 'Monthly Chart', category: 'Chart' },
  { type: 'progress_pct', label: 'Progress Percent', category: 'Chart' },
  { type: 'area_chart_weekly', label: 'Area Chart Weekly', category: 'Chart' },
  { type: 'dot_progress', label: 'Dot Progress', category: 'Chart' },
  { type: 'square_progress', label: 'Square Progress', category: 'Chart' },
  { type: 'vertical_bars', label: 'Vertical Bars', category: 'Chart' },
  { type: 'stacked_days', label: 'Stacked Days', category: 'Recap' },
  { type: 'running_total', label: 'Running Total', category: 'Recap' },
  { type: 'weekly_map', label: 'Weekly Map', category: 'Map' },
];
